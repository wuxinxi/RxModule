...
public class SignUtil {
    ...
    public static String paramSign(HashMap<String, String> params, byte[] clientPriKey, ArrayList<String> ignore) {
        String parmsSortStr = SignUtil.sortConstructVars(params, false, ignore);
